...
impl Task {
    pub(crate) fn new(id: usize, worst_case_execution_time: usize, best_case_execution_time: usize, relative_deadline: usize, period: usize) -> Self{
        Self{
            id,
    ...
    fn randomly_generate_jobs(&mut self, num_jobs: usize){
